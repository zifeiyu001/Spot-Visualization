            ...
            if (data.length>0) {
                for (var a = 0; a < data.length; a++) {
                    if (data[a].equip === '生产') {
                        ...
                        normal1.push(data[a].normal);
                        danger1.push(data[a].danger);
                        alarm1.push(data[a].alarm);
                        incomplete1.push(data[a].incomplete);
                    } else if (data[a].equip === '工段'){
                        complete2.push(data[a].complete);
                        normal2.push(data[a].normal);
