...
function reqs2() {
    ...
    $.ajax({
        ...
        url : "/spot/ts/spot",    //请求发送到TestServlet处
        data : {},
        ...
        success : function(result) {
            ...
            if(data.length>0) {
                ...
                $("#djdata").text("当日无点检任务").css("margin-top","44%").css("margin-left","29%").css("color","#FFFFFF").css("font-size","16px");
            }
        },
        complete: function () {
            isLoaded2 = true;
...
function reqs3(){
    ...
    $.ajax({
        type : "get",
        async : false,            //异步请求（同步请求将会锁住浏览器，用户其他操作必须等待请求完成才可以执行）
        url : "/spot/ts/defect_treatment",    //请求发送到TestServlet处
        data : {},
        dataType : "json", //返回数据形式为json
        beforeSend: function () {
            isLoaded3= false;
        ...
        success : function(result) {
            ...
            if(data.length>0) {
                ...
                $("#qxcl").text("无缺陷").css("margin-top","44%").css("margin-left","40%").css("color","#FFFFFF").css("font-size","16px");
            }
        },
        complete: function () {
            isLoaded3 = true;
