...
function reqs1() {
    ...
    $.ajax({
        ...
        url : "/spot/ns/ndll",    //请求发送到TestServlet处
        data : {},
        ...
        success : function(result) {
            ...
            if(data.length>0) {
                    for (var a = 0; a < data.length; a++) {
                        NDJ1NDs.push(data[a].ndj1ND);
                    }
                    for (var b = 0; b < data.length; b++) {
                        NDJ1Vs.push(data[b].ndj1V);
                    }
                    for (var c = 0; c < data.length; c++) {
                        NDJ2NDs.push(data[c].ndj2ND);
                    }
                    for (var d = 0; d < data.length; d++) {
                        NDJ2Vs.push(data[d].ndj2V);
                    }
                    for (var e = 0; e < data.length; e++) {
                        NDJ4NDs.push(data[e].ndj4ND);
                    }
                    for (var f = 0; f < data.length; f++) {
                        NDJ4Vs.push(data[f].ndj4V);
                    }
                ...
                $("#scdata").text("当日无数据").css("margin-top","25%").css("margin-left","35%").css("color","#FFFFFF").css("font-size","16px");
            }
