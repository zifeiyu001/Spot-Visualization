...
<head>
    ...
    #btn3{
        /*background-color: rgba(255, 76, 228, 0.97);*/
        width: 4%;
        height: 12%;
        left: 29%;
        top: 41%;
 ...
 <#--主图-->
        <div class="show" >
            <#--点检数据弹窗-->
                ...
                <a id="btn4" class="spotButton" onclick="getDetailedData1('param3');"   ></a>
                <a id="btn5" class="spotButton" onclick="getDetailedData1('param4');"   ></a>
