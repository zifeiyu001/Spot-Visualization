...
<head>
    ...
    /*生产数据以及图例模块*/
        ...
        #spotZmj{height: 98% !important;width: 98% !important;}
    ...
    /*图片*/
        #pic{width: 96%;height: 91%;min-height: 300px;min-width: 400px;margin-top: 4%;margin-right: 1%;}
    ...
    /*详细数据*/
        ...
        #detaileddata .myTable tbody td{font-size: 14px;padding: 2px;}
