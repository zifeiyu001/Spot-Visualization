...
<#--导航栏-->
 ...
 <#--主图-->
        <div class="show" >
            <div id="pic1" class="pic"><img src="/images/equipment/fx/gfj.png">2#鼓风机</div>
            <div id="pic2" class="pic"><img src="/images/equipment/fx/xyz.png">2#鼓风机稀油站</div>
        </div>
        <div class="spot">
...
<script  src="/js/equipment/SpotFXGfj2.js"></script>
