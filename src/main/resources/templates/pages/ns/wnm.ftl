...
<head>
    ...
    <style>
        #btn1{width: 7%;height: 17%;left: 58%;top: 49%;}
        #btn2{width: 7%;height: 15%;left: 45%;top: 17%;}
        #btn3{width: 18%;height: 30%;left: 52%;top: 18%;}
        /*设备图片*/
        #pic1{ width: 100%;height: 80%;left: 0;top: 7%;}
    </style>
</head>
<body >
<#--点检数据弹窗-->
...
<script  src="/js/equipment/SpotNSWNM.js"></script>
