...
<head>
    ...
    <style>
        #btn1{width: 10%;height: 17%;left: 37%;top: 29%;}
        #btn2{width: 12%;height: 20%;left: 50%;top: 41%;}
        #btn3{width: 5%;height: 18%;left: 35%;top: 61%;}
        #btn4{width: 5%;height: 15%;left: 40%;top: 67%;}
        #btn5{width: 5%;height: 18%;left: 49%;top: 61%;}
        #btn6{width: 5%;height: 15%;left: 54%;top: 67%;}
    /*设备图片*/
        #pic1{    width: 80%;height: 58%;left: 8%;top: 7%;}
        #pic2{width: 25%;height: 25%;left: 21%;top: 0%;}
        #pic3{       width: 25%;height: 25%;left: 27%;top: 0%;}
    </style>
</head>
<body >
<#--点检数据弹窗-->
...
<#--导航栏-->
 ...
 <#--主图-->
        <div class="show" >
            ...
            <div id="pic2" class="pic"><img src="/images/equipment/jw/beng.png">1#离心式渣浆泵</div>
            <div id="pic3" class="pic"><img src="/images/equipment/jw/beng.png">2#离心式渣浆泵</div>
        </div>
        <div class="spot">
...
<script>
    ...
    function getDetailedData1(param) {
        $.ajax({
            url:"/spot/ns/sgnm/detailed/test",
            type:"post",
            // cache:false,
            // async: false,
