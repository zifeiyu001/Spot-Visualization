...
<head>
    ...
    <style>
        ...
        #btn2{width: 9%;height: 19%;left: 31%;top: 63%;}
        #btn3{width: 27%;height: 29%;left: 38%;top: 34%;}
        /*设备图*/
...
<#--导航栏-->
 ...
 <#--主图-->
        <div class="show" >
            <div id="pic1" class="pic"><img src="/images/equipment/jw/ylj3.png"></div>
        </div>
        <div class="spot">
...
<script>
    ...
    function getDetailedData1(param) {
        $.ajax({
            url:"/spot/ts/ylj3/detailed/test",
            type:"post",
            // cache:false,
            // async: false,
