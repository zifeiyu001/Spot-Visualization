...
<head>
    ...
    /*生产数据以及图例模块*/
        ...
        .spotstatistics {width: 100%;height: 49%;min-width: 200px;margin: 2px;background-size: 100% 100%;background-image: url("/images/module/aleftboxtbott.png");}
    ...
    /*磨浮图例*/
        #legend2{width: 98%;height: 13%;min-width: 200px;margin-bottom: 1px;
    ...
    /*图片图例位置样式*/
        ...
        #sb-num1 {     left: 20%;bottom: 63%;}
        #sb-num2 {       left: 33%; bottom: 47%;}
        #sb-num3 {   left: 33%; bottom: 47%;}
        #sb-num4 {           left: 41%;
            bottom: 62%;}
        #sb-num5 {    left: 42%;
            bottom: 67%;}
        ...
        #sb-num9 {            left: 47%;
            bottom: 50%;}
        #sb-num10 {        left: 36%; bottom: 66%;}
        #sb-num11 {    left: 37%; bottom: 67%;}
        #sb-num12 {    left: 45%; bottom: 52%;}
        #sb-num13 {    left: 45%;bottom: 48%;}

        /*电仪*/
        .dy-num{float: left;position: relative;}
        #dy-num1 {     left: 47%;bottom: 54%;}

        /*生产*/
        .sc-num{float: left;position: relative;}
        #sc-num1{           left: 18%;  bottom: 73%;}
        #sc-num2{        left: 36%;bottom: 58%;}
        #sc-num3{   left: 29%;bottom: 48%;}
        #sc-num4{          left: 18%;bottom: 69%;}
        #sc-num5{            left: -19%;bottom: 67%;}
...
<#--导航栏-->
 ...
 <#--主图-->
    ...
    <script  src="/js/equipment/SpotSKPD4.js"></script>
