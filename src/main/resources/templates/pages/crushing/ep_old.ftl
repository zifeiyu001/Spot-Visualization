...
<head>
    ...
    <style>
    /*背景*/
      body{background-image: url("/images/background.jpg");background-size: 100% 100%;background-attachment: fixed;width: auto;height: 100%;margin: 0;padding: 0;overflow: hidden;}
    /* 设置滚动条的样式 ---纵向,横向*/
    ...
    /*生产数据以及图例模块*/
        ...
        .spotstatistics {width: 100%;height: 41%;min-width: 200px;margin: 2px;background-size: 100% 100%;background-image: url("/images/module/aleftboxtbott.png");}
        .spotStatistics_title{text-align: center ;color: #FFFFFF;padding-top: 1%;height: 8%;font-size: 12px;}
        .statistics{width: 100%;height: 91%;}
        #spotep{height: 98% !important;width: 98% !important;}
    ...
    /*磨浮图例*/
        #legend2{width: 98%;height: 16%;min-width: 200px;margin-bottom: 1px;
    ...
    /*主图*/
        .show{width:56%;height:100%;min-width: 400px;margin: 0 0.5% ;float: left;text-align: center;
    ...
    /*图片*/
        /*.pic{width: 90%;height: 90%;min-height: 300px;min-width: 400px;*/
            ...
            .pic{float: left;position: relative;color: #FFFFFF; top: 25%;}
            .pic img{width: 100%;height: 100%;float: left}
            #pic1{width: 60%;height: 60%;}
            #pic2{width: 40%;height: 60%;}
    ...
    /*图片图例位置样式*/
        ...
        #sb-num1 {     left: 4%;bottom: -9%;}
        #sb-num2 {       left: 24%;bottom: 34%;}
        #sb-num3 {        left: 15%;bottom: 14%;}
        #sb-num4 {      left: 10%; bottom: -4%;}
        #sb-num5 {       left: 24%; bottom: 20%;}
        #sb-num6 {    left: 27%; bottom: 21%;}
        #sb-num7 {   left: 27%;   bottom: 21%;}
        #sb-num8 {left: 59%;  bottom: 1%;}
        #sb-num9 {    left: 61%;bottom: 24%;}
        #sb-num10 {      left: 45%;
            bottom: 24%;}
        #sb-num11 {       left: 48%;bottom: 31%;}
        #sb-num12 {        left: 37%;
            bottom: 16%; }
        #sb-num13 {         left: 50%;
            bottom: 1%;}
        ...
        /*电仪*/
        .dy-num1{float: left;position: relative;font-size: 15px}
        .dy-num2{float: left;position: relative;font-size: 18px;}
        #dy-num1 {    left: -20%;bottom: -15%;}
        #dy-num2 {       left: 41%;bottom: 19%;}
        #dy-num3 {       left: 45%;bottom: 19%;}
        #dy-num4 {       left: 41%;bottom: 15%;}

        /*生产*/
        .sc-num{float: left;position: relative;font-size: 15px}
        #sc-num1{       left: -21%;bottom: 17%;}
        #sc-num2{        left: -7%;bottom: 16%;;}
        #sc-num3{    left: -7%;bottom: 16%;}
        #sc-num4{        left: -47%;bottom: -17%;}
        #sc-num5{      left: 17%;bottom: 16%;}
        #sc-num6{        left: -49%;bottom: 3%;}
        #sc-num7{         left: -22%;bottom: -21%;}
        #sc-num8{         left: -22%;bottom: -21%;}
        #sc-num9{         left: -22%;bottom: -21%;}
    /*报警区域*/
    .main  .alarm{
 ...
 <#--主图-->
        <div class="show" >
            ...
            <#--设备-->
                ...
                <span id="sb-num13" class="sb-num2">⑱</span>



            <#--电仪-->
                <span id="dy-num1" class="dy-num1">①②<br>③④</span>
                <span id="dy-num2" class="dy-num1">⑤⑥<br>⑦⑧</span>
                <span id="dy-num3" class="dy-num1">⑨⑩</span>
                <span id="dy-num4" class="dy-num2">⑪⑫</span>
