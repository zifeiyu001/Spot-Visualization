            ...
            <div class="col-sm-9" style="margin-left:13%;">
                ...
                <nav class="navbar navbar-default">
                    <ul class="nav nav-tabs nav-justified">
                        <li class="active"><a href="#" >工段报表</a></li>
                ...
                <div class="col-sm-12">
                    <form action="#" onsubmit="return false;" id="myform" name="myform" class="form-horizontal" role="form" style="margin-top:10px;">
                        <div class="form-group" id="datet" style = "width:auto;">
                        ...
                        <#--<div class="form-group" id="datet" style = "width:auto;margin-left:5%">-->
                            <label for="name" class="col-sm-2 control-label" style = "width:auto">开始日期</label>
                            <div class="col-md-4" style = "width:20%">
                                <input class="form-control" id="startDate" name="startDate" type="text" placeholder="请选择" readonly style = "width:auto">
                            </div>
                            <label for="name" class="col-sm-2 control-label" style = "width:auto">结束日期</label>
                            <div class="col-md-4" style = "width:20%">
                                <input class="form-control" id="endDate" name="endDate" type="text" placeholder="请选择" readonly style = "width:auto">
                            </div>
                            <div class="query">
                                <input type="button" class="btn btn-primary"  style="    margin-left: 2%; margin-right: 2%;" onclick="search()"  value="查询">

                            <input type="button"  class="btn btn-primary" value="导出报表" onclick="method1('tables')" />
                            </div>
                        </div>
                    </form>
                </div>
